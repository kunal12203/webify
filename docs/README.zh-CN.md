...
为 AI 编程代理提供自适应网络研究能力。搜索网页、构建 DOM 结构图、获取综合答案——成本仅为深度研究工具的 5%。
...
**web_find** 搜索 DuckDuckGo，从多个来源并行构建 DOM 结构图，通过 BM25 提取相关内容，并使用 Haiku 进行综合。它根据查询复杂度自适应调整深度——简单的事实查询命中 3 个来源，多维度研究查询可扩展到 6 个以上来源并进行多方面检索。
